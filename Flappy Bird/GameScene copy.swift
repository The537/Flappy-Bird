...
class GameScene: SKScene, SKPhysicsContactDelegate {
	...
	let sound = SKAction.playSoundFileNamed("sfx_point.wav" , waitForCompletion: false)
	
	let sound2 = SKAction.playSoundFileNamed("sfx_die.wav" , waitForCompletion: true)
	...
	func setupGame() {
		...
		let  backg = SKAudioNode(fileNamed: "Flappy Bird Theme Song.mp3")
		
		self.addChild(backg)
		
		self.gameBackgroundMusic = backg
